...
let points = 0;
// --------------------   Easy Questions
let question1 = `Which planet is known as the "Red Planet"?`; //  b
let question2 = `Which of the following animals is known for its distinctive sound "oink oink"?`; //  a
let question3 = `What is the capital city of France?`; //  a
let question4 = `Which Disney character's original name was "Mortimer Mouse"?`; //  b
let question5 = `What is the largest living species of lizard?`; //  a
let question6 = `Which of the following fruits is often red or green when it's ripe?`; //  d 
let question7 = `Who is the main character in the book "The Wizard of Oz"?`; //  a
let question8 = `What is the smallest country in the world, both in terms of population and land area?`; //  a
let question9 = `Which of the following musical instruments is often associated with the country of Scotland?`; //  d
let question10 = `What is the chemical symbol for gold?`; //  a
// --------------------   Medium Questions
let question01 = `What is the purpose of the "git add" command in Git version control?`; //  c
let question02 = `Which programming language is known for its use of garbage collection, and is commonly used for Android app development?`; //  a
let question03 = `What is the primary function of the BIOS (Basic Input/Output System) in a computer?`; //  c
let question04 = `Which type of RAM (Random Access Memory) is faster and more expensive than DDR3, but is not backward compatible?`; //  c
let question05 = `What is the purpose of the DHCP (Dynamic Host Configuration Protocol) protocol?`; //  d
let question06 = `Which type of network attack involves an attacker sending a large amount of traffic to a network in an attempt to overwhelm it?`; //  c
let question07 = `What is the primary function of the HTTP (Hypertext Transfer Protocol) protocol?`; //  c
let question08 = `Which web development framework is known for its use of templates and is commonly used for building scalable web applications?`; //  c
let question09 = `What is the purpose of a firewall in a computer network?`; //  a
let question010 = `Which type of encryption is commonly used for secure online transactions, and is based on the principle of public-key cryptography?`; //  b
// --------------------   Difficult Questions
let question001 = `What is the primary purpose of TypeScript?`; //  a
let question002 = `What is the purpose of the any type in TypeScript?`; //  a
let question003 = `What is the purpose of an interface in TypeScript?`; //  c
let question004 = `What is the difference between a class and an interface in TypeScript?`; //  b
let question005 = `What is the purpose of the export keyword in TypeScript?`; //  b
let question006 = `What is type inference in TypeScript?`; //  c
let question007 = `What is the purpose of an enum in TypeScript?`; //  d
let question008 = `What is the purpose of generics in TypeScript?`; //  c
let question009 = `What is the purpose of a type guard in TypeScript?`; //  a
let question0010 = `Is TypeScript compatible with existing JavaScript code?`; //  b
